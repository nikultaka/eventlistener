...
@section('adminTitle', 'Admin | Manage Category')
@section('breadcrumbFirst', 'Manage Category')
@section('breadcrumbSecond', 'Category')
                ...
                <div class="row">
                    <div class="col-md-12">
						<div style="float: right">
                            <button type="button" id="categoryModelBtn" class="btn btn-blue float-right"><i class="entypo-user-add"></i> Add Category</button>
                        </div>
						<br />
						<br />
						<br />
