        ...
        $("#mainform").validate({
            ...
            submitHandler: function(form) {
                ...
                if ($(`#offers_data`).val().length == 0) {
                    ...
                    $.ajax({
                        url: BASE_URL + '/campaigns-revisions/revision',
                        type: "POST",
                        headers: {
            ...
            success: function(response) {
                ...
                if (!response.status) {
                    ...
                    setTimeout(function() {
                        ...
                        $(`#offers_data`).html(response.data.campaign_offerings);
                        jQuery.each(offerdata, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-offer"  data-count="${val.offer_id}">
                            <div class="information-box">
                                <div class="row">
                                    <div class="col-sm-1 col-md-1">
                        ...
                        $(`#highlights_data`).html(response.data.campaign_highlights);
                        jQuery.each(Highlights, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-highlights" data-count="${val.highlight_id}">
                            <div class="information-box">
                                <div class="row">
                                    <div class="col-sm-1 col-md-1">
                        ...
                        $(`#board_data`).html(response.data.board_member);
                        jQuery.each(Board, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-boardteam data-items data-boardteam" data-count="${val.board_id}">
                        <div class="information-box">
                            <div class="row">
                                <div class="col-sm-1 col-md-1">
                        ...
                        $(`#voting_data`).html(response.data.voting_power);
                        jQuery.each(Voting, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-voting" data-count="${val.voting_id}">
                        <div class="information-box">
                            <div class="row">
                                <div class="col-sm-1 col-md-1">
                        ...
                        $(`#risk_data`).html(response.data.investor_risks);
                        jQuery.each(Risks, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-risk" data-count="${val.risk_id}">
                        <div class="information-box">
                            <div class="row">
                                <div class="col-sm-1 col-md-1">
                        ...
                        $(`#fundraising_data`).html(response.data.use_of_fundraising);
                        jQuery.each(Fundraising, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-fundraising" data-count="${val.fundraising_id}">
                        <div class="information-box">
                            <div class="row">
                                <div class="col-sm-1 col-md-1">
                        ...
                        $(`#transactions_data`).html(response.data.party_transactions);
                        jQuery.each(Transactions, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-transactions" data-count="${val.transactions_id}">
                        <div class="information-box">
                            <div class="row">
                                <div class="col-sm-1 col-md-1">
                        ...
                        $(`#questions_data`).html(response.data.asked_questions);
                        jQuery.each(Questions, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-questions" data-count="${val.questions_id}">
                        <div class="information-box">
                            <div class="row">
                                <div class="col-sm-1 col-md-1">
                        ...
                        $(`#discussion_data`).html(response.data.discussion_topics);
                        jQuery.each(Discussion, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-discussion" data-count="${val.discussion_id}">
                        <div class="information-box">
                            <div class="row">
                                <div class="col-sm-1 col-md-1">
                        ...
                        $(`#officers_data`).html(response.data.officer_member);
                        jQuery.each(Officers, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-officers"  data-count="${val.officers_id}">
                        <div class="information-box">
                            <div class="row">
                                <div class="col-sm-1 col-md-1">
                        ...
                        $(`#team_data`).html(response.data.team_member);
                        jQuery.each(Team, function(i, val) {
                            ...
                            const html = `<div class="col-md-12 mb-4 data-items data-team" data-count="${val.team_id}">
                        <div class="information-box">
                            <div class="row">
                                <div class="col-sm-1 col-md-1">
                        ...
                        if (response.data.assets_structure_showcase != "") {
                            ...
                            $(`#asset_data`).html(response.data.assets_structure_showcase);
                            jQuery.each(Assets, function(i, val) {
                                ...
                                const html = `<div class="col-md-12 mb-4 data-items data-asset" data-count="${val.asset_id}">
                    <div class="information-box">
                        <div class="row">
                            <div class="col-sm-1 col-md-1">
                        ...
                        if (response.data.debts_structure_showcase != "") {
                            ...
                            $(`#debt_data`).html(response.data.debts_structure_showcase);
                            jQuery.each(Debts, function(i, val) {
                                ...
                                const html = `<div class="col-md-12 mb-4 data-items data-debt" data-count="${val.debt_id}">
                    <div class="information-box">
                        <div class="row">
                            <div class="col-sm-1 col-md-1">
                        ...
                        if (response.data.equity_structure_showcase != "") {
                            ...
                            $(`#equity_data`).html(response.data.equity_structure_showcase);
                            jQuery.each(Equity, function(i, val) {
                                ...
                                const html = `<div class="col-md-12 mb-4 data-items data-equity" data-count="${val.equity_id}">
                    <div class="information-box">
                        <div class="row">
                            <div class="col-sm-1 col-md-1">
                        ...
                        if (response.data.revisions_column != null) {
                            var validation = (response.data.revisions_column).split(',')
                            for (let i = 0; i < validation.length; i++) {
                                $(`[data-errorh =${validation[i]}]`).addClass('form-control is-invalid', true);
                            }
                        }



                        const html = `  <div class="center-sidebar border fixed-height mt-3 mb-3 sidebar-error">
                        <h3 class="border-after mb-3">Campaign Sections</h3>
                        <div class="form-check mb-3 ${jQuery.inArray("Campaign ID", validation) != -1 ? 'error' : jQuery.inArray("Campaign Title", validation) != -1 ? 'error' : ''}">
                        ...
                        <div class="form-check mb-3 ${jQuery.inArray(" Video Upload", validation) != -1 ? 'error' : ''}">
                        ...
                        <div class="form-check mb-3 ${jQuery.inArray("Company Description", validation) != -1 ? 'error' : ''}">
                        ...
                        <div class="form-check mb-3  ${jQuery.inArray("Investment Terms", validation) != -1 ? 'error' : ''}">
                            <input class="form-check-input item-check" type="checkbox" value="" id="flexCheckDefault4">
                            <label class="form-check-label item-lable" for="flexCheckDefault3">
                                Campaign Investment Terms
                            </label>
                        </div>
                        <div class="form-check mb-3  ${jQuery.inArray("offer-module", validation) != -1 ? 'error' : ''}">
                        ...
                        <div class="form-check mb-3  ${jQuery.inArray("highlights-module", validation) != -1 ? 'error' : ''}">
                        ...
                        <div class="form-check mb-3  ${jQuery.inArray("team-module", validation) != -1 ? 'error' : ''}">
                        ...
                        <div class="form-check mb-3  ${jQuery.inArray("board-module", validation) != -1 ? 'error' : ''}">
                        ...
                        <div class="form-check mb-3  ${jQuery.inArray("officers-module", validation) != -1 ? 'error' : ''}">
                        ...
                        <div class="form-check mb-3  ${jQuery.inArray("voting-module", validation) != -1 ? 'error' : ''}">
                            <input class="form-check-input item-check" type="checkbox" value="" id="office"
...
function Addoffer() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-offer remove-data"  data-count="${val.offer_id}">
        <div class="information-box">
            <div class="row">
                <div class="col-sm-1 col-md-1">
                    <span class="text">${('0' + val.offer_id).slice(-2)}</span>
...
function Addhighlights() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-highlights remove-data"  data-count="${val.highlight_id}">
        <div class="information-box">
            <div class="row">
                <div class="col-sm-1 col-md-1">
                    <span class="text">${('0' + val.highlight_id).slice(-2)}</span>
...
function Addboardteam() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-boardteam remove-data"  data-count="${val.board_id}">
    <div class="information-box">
        <div class="row">
            <div class="col-sm-1 col-md-1">
                <span class="text">${('0' + val.board_id).slice(-2)}</span>
...
function Addvoting() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-voting remove-data"  data-count="${val.voting_id}">
    <div class="information-box">
        <div class="row">
            <div class="col-sm-1 col-md-1">
                <span class="text">${('0' + val.voting_id).slice(-2)}</span>
...
function Addrisk() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-risk remove-data"  data-count="${val.risk_id}">
    <div class="information-box">
        <div class="row">
            <div class="col-sm-1 col-md-1">
                <span class="text">${('0' + val.risk_id).slice(-2)}</span>
...
function Addfundraising() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-fundraising remove-data"  data-count="${val.fundraising_id}">
    <div class="information-box">
        <div class="row">
            <div class="col-sm-1 col-md-1">
                <span class="text">${('0' + val.fundraising_id).slice(-2)}</span>
...
function Addtransaction() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-transactions remove-data"  data-count="${val.transactions_id}">
    <div class="information-box">
        <div class="row">
            <div class="col-sm-1 col-md-1">
                <span class="text">${('0' + val.transactions_id).slice(-2)}</span>
...
function Addquestion() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-questions remove-data"  data-count="${val.questions_id}">
    <div class="information-box">
        <div class="row">
            <div class="col-sm-1 col-md-1">
                <span class="text">${('0' + val.questions_id).slice(-2)}</span>
...
function Adddiscussion() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-discussion remove-data"  data-count="${val.discussion_id}">
    <div class="information-box">
        <div class="row">
            <div class="col-sm-1 col-md-1">
                <span class="text">${('0' + val.discussion_id).slice(-2)}</span>
...
function Addofficers() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-officers remove-data"  data-count="${val.officers_id}">
    <div class="information-box">
        <div class="row">
            <div class="col-sm-1 col-md-1">
                <span class="text">${('0' + val.officers_id).slice(-2)}</span>
...
function Addteam() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-team remove-data"  data-count="${val.team_id}">
    <div class="information-box">
        <div class="row">
            <div class="col-sm-1 col-md-1">
                <span class="text">${('0' + val.team_id).slice(-2)}</span>
...
function Addasset() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-asset remove-data"  data-count="${val.asset_id}">
<div class="information-box">
    <div class="row">
        <div class="col-sm-1 col-md-1">
            <span class="text">${('0' + val.asset_id).slice(-2)}</span>
...
function Adddebt() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-debt remove-data"  data-count="${val.debt_id}">
<div class="information-box">
    <div class="row">
        <div class="col-sm-1 col-md-1">
            <span class="text">${('0' + val.debt_id).slice(-2)}</span>
...
function Addequity() {
    ...
    jQuery.each(data, function(i, val) {
        ...
        const html = `<div class="col-md-12 mb-4 data-equity remove-data"  data-count="${val.equity_id}">
<div class="information-box">
    <div class="row">
        <div class="col-sm-1 col-md-1">
            <span class="text">${('0' + val.equity_id).slice(-2)}</span>
